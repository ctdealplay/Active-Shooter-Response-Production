...
namespace PA_DronePack
{
    public class PA_DroneCamera : MonoBehaviour
    {
        ...
        public void ChangeCameraMode() { print("# cameraMode"); cameraMode = (cameraMode == CameraMode.firstPerson) ? CameraMode.thirdPerson : CameraMode.firstPerson; }
