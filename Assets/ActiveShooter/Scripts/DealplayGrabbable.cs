...
namespace Oculus.Interaction
{
    ...
    /// </summary>
    public class DealplayGrabbable : PointableElement, IGrabbable, ITimeConsumer
    {
        /// <summary>
        ...
        public static Action<bool> s_GrabBegin;
        public static Action<bool> s_GrabRelease;
        [SerializeField]
        private bool m_CanThrowEvent = false;
        [SerializeField]
        private Button m_RadioButton;
        [SerializeField]
        private bool m_IsRadioPlayback;
        ...
        private void BeginTransform()
        {
            ...
            if (m_CanThrowEvent)
            {
                if (!m_IsRadioPlayback)
                {
                    m_RadioButton.onClick.Invoke();
                }
                s_GrabBegin?.Invoke(m_IsRadioPlayback);
        ...
        private void EndTransform()
        {
            ...
            if (m_CanThrowEvent)
            {
                ...
                s_GrabRelease?.Invoke(m_IsRadioPlayback);
            }
