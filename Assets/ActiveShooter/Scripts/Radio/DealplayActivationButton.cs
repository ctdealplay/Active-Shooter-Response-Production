...
namespace Oculus.VoiceSDK.UX
{
    ...
    public class DealplayActivationButton : MonoBehaviour
    {
        /// <summary>
        ...
        private void OnEnable()
        {
            ...
            ActiveShooter_ConversationPanel.s_ActivationCallback += Activate;
            ActiveShooter_ConversationPanel.s_DeactivationCallback += Deactivate;
        }
